...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        ...
        return new ApiInfoBuilder()
                ...
                .description("Microservice Ressources cours est un API qui s'occupe de la Gestion des cours, " +
                        " etc.")
                .termsOfServiceUrl("https://www.ici.com")
                .license("dioufserignemor")
                .licenseUrl("https://www.diouf.com")
                .version("1.0")
                .contact(new Contact("diouf", "https://www.diouf.com", "charlesaze7@gmail.com"))
                .build();
