...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        ...
        return new ApiInfoBuilder()
                .title("Documentation Gestion des classes")
                .description("Microservice gestion des classes est un API qui s'occupe de la Gestion des classe, " +
                        " etc.")
