...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        ...
        return new ApiInfoBuilder()
                ...
                .description("Microservice professeur est une API qui s'occupe de la Gestion des professeurs, " +
                        " etc.")
                .termsOfServiceUrl("https://www.ici.com")
                .license("dioufserignemor")
                .licenseUrl("https://www.diouf.com")
                .version("1.0")
                .contact(new Contact("diouf", "https://www.diouf.com", "a.dioufserigne@@gmail.com"))
                .build();
